...
nix-shell --pure -p racket-minimal nix-prefetch-git --run "$racket2nix/racket2nix --catalog catalog.rktd.in --catalog $racket2nix/catalog.rktd --export-catalog cardano-wallet | racket -e '(pretty-write (read))' > catalog.rktd"
